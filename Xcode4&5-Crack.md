...
PATH="$XCODE_BASE"/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS*.sdk/
...
XCODE_BASE=$(/usr/bin/xcrun -f otest | /usr/bin/sed s/"\/Tools\/otest"//g)

PATH="$XCODE_BASE"/Platforms/iPhoneOS.platform
...
$ PATH="$XCODE_BASE"/Platforms/iPhoneOS.platform/Developer/Library/Xcode/PrivatePlugIns/iPhoneOS\ Build\ System\ Support.xcplugin/Contents/MacOS
...
export CODESIGN_ALLOCATE=$XCODE_BASE/Platforms/iPhoneOS.platform/Developer/usr/bin/codesign_allocate
